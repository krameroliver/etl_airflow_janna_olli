...
from biz_beladung.l_gp_konto import Link_GP_KONTO
...
def load_subdag(parent_dag_name, child_dag_name, args):
    ...
    link_gp_konto_join = PythonOperator(
        task_id="link_gp_konto_join",
    ...
    link_gp_konto_map = PythonOperator(
        task_id="link_gp_konto_map",
    ...
    link_gp_konto_load = PythonOperator(
        task_id="link_gp_konto_load",
    ...
    startAllTasks >> link_gp_konto_join >> link_gp_konto_map >> link_gp_konto_load >> endTasks
    return d

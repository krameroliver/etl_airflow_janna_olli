...
from biz_beladung.l_transaktion_konto import Link_TRANS_KONTO
...
link = Link_TRANS_KONTO('2018-12-31')
...
def load_subdag(parent_dag_name, child_dag_name, args):
    ...
    link_trans_konto_join = PythonOperator(
        task_id="link_trans_konto_join",
    ...
    link_trans_konto_map = PythonOperator(
        task_id="link_trans_konto_map",
    ...
    link_trans_konto_load = PythonOperator(
        task_id="link_trans_konto_load",
    ...
    startAllTasks >> link_trans_konto_join >> link_trans_konto_map >> link_trans_konto_load >> endTasks
    return d

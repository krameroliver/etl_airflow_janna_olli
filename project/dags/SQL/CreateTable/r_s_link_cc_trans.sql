...
CREATE TRIGGER versioning_trigger_r_s_link_cc_trans BEFORE INSERT OR UPDATE OR DELETE ON bizSCHEMA_ID.r_s_link_cc_trans FOR EACH ROW EXECUTE PROCEDURE versioning('effectiv_timerange', 'bizSCHEMA_ID.r_s_link_cc_trans_hist', true);
